...
import { FileVideo, Upload, Loader2, CheckCheck } from 'lucide-react'
...
export function VideoInputForm(props: VideoInputFormProps) {
  ...
  return (
    <form onSubmit={handleUploadVideo} className="space-y-6">
      <label 
        htmlFor="video" 
        className="relative border flex flex-col gap-2 items-center justify-center rounded-md aspect-video cursor-pointer border-dashed text-sm text-muted-foreground hover:bg-primary/5"
      >
        {previewURL ? (
